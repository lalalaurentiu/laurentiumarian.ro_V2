...
export default function Mail(props) {
  return (
    <div className="flex flex-col absolute w-screen h-screen top-0 z-20 bg-[#242424] lg:top-2/4 lg:left-2/4 lg:transform lg:-translate-x-2/4 lg:-translate-y-2/4 lg:w-3/4 lg:h-3/4 lg:rounded-lg lg:border-[0.5px] lg:border-gray-400">
